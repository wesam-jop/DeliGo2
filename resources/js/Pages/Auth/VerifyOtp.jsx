    ...
    return (
        <div className="w-full max-w-md mx-auto">
            ...
            >
                ...
                <h1 className="text-2xl font-black text-slate-900 mb-2">التحقق من رقم الهاتف</h1>
                <p className="text-slate-500 font-bold">
                    أدخل رمز التحقق المرسل إلى <span className="font-black text-brand italic underline decoration-brand/20 underline-offset-4">{phone}</span>
                </p>
                {role !== 'customer' && (
